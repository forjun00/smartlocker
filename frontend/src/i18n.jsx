...
const STRINGS = {
  ...
  'lk.copy.inuse':    { th: 'มีพัสดุรออยู่ ผู้รับเปิดได้โดยใส่เบอร์โทรที่ใช้ตอนฝากพัสดุ',
                        en: 'A delivery is waiting. The recipient opens it by entering the phone number used at drop-off.' },
  'lk.copy.sealed':   { th: 'ปิดผนึกแล้ว แจ้งเตือนไปที่ {phone} แล้ว ผู้รับเปิดได้ด้วยเบอร์โทรที่ตู้',
                        en: 'Sealed. We notified {phone}. The recipient opens it at the locker with their phone number.' },
  ...
  'lk.hint.orsms':    { th: 'ใส่เบอร์โทรที่ผู้ส่งกรอกตอนฝากพัสดุ', en: 'Enter the phone number the sender used at drop-off.' },
